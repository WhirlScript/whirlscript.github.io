import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.jBbNkKut.js";const g=JSON.parse('{"title":"Struct","description":"","frontmatter":{"prev":{"text":"Template String","link":"/guide/getting-started/template-string"},"next":{"text":"Namespace","link":"/en/guide/getting-started/namespace"}},"headers":[],"relativePath":"guide/getting-started/struct/index.md","filePath":"guide/getting-started/struct.md"}'),t={name:"guide/getting-started/struct/index.md"},l=e(`<h1 id="struct" tabindex="-1">Struct <a class="header-anchor" href="#struct" aria-label="Permalink to &quot;Struct&quot;">​</a></h1><p>Struct(structure) are another user-defined data type available in WhirlScript, allowing you to store different types of data items.</p><p>Data members in a struct can be basic data types (<code>boolean</code>, <code>int</code>, and <code>string</code>), or other struct types.</p><h2 id="declaration" tabindex="-1">Declaration <a class="header-anchor" href="#declaration" aria-label="Permalink to &quot;Declaration&quot;">​</a></h2><p>Struct are declared using the <code>struct</code> keyword:</p><div class="language-WhirlScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">WhirlScript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">struct MyStruct {</span></span>
