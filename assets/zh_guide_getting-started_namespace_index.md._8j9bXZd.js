import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.jBbNkKut.js";const u=JSON.parse('{"title":"命名空间","description":"","frontmatter":{"prev":{"text":"结构体","link":"/zh/guide/getting-started/struct"},"next":{"text":"目标限定符","link":"/zh/guide/getting-started/target-specify"}},"headers":[],"relativePath":"zh/guide/getting-started/namespace/index.md","filePath":"zh/guide/getting-started/namespace.md"}'),l={name:"zh/guide/getting-started/namespace/index.md"},e=p(`<h1 id="命名空间" tabindex="-1">命名空间 <a class="header-anchor" href="#命名空间" aria-label="Permalink to &quot;命名空间&quot;">​</a></h1><p>WhirlScript 没有类的概念。作为替代，如果你希望将变量和函数按照功能分开，可以使用命名空间。</p><h2 id="定义一个命名空间" tabindex="-1">定义一个命名空间 <a class="header-anchor" href="#定义一个命名空间" aria-label="Permalink to &quot;定义一个命名空间&quot;">​</a></h2><p>你可以使用 <code>namespace</code> 语句定义一个命名空间。例如，以下代码定义了一个命名空间，它包含函数 <code>max</code>：</p><div class="language-WhirlScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">WhirlScript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">namespace Math{</span></span>
